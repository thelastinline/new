  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      function usa(){
          ...
          echo "<a href='http://www.pressdisplay.com/pressdisplay/es/services/OnlinePrintHandler.ashx?issue=1835".$date."00000000001001&page=1&paper=A4' target='_blank' >eral sum</a>" ."</br>" ;          
          echo "<a href='http://www.pressdisplay.com/pressdisplay/es/services/OnlinePrintHandler.ashx?issue=1120".$date."00000000001001&page=1&paper=A4' target='_blank' >tyhe daily telegram</a>" ."</br>" ;         
          ?>"; }
